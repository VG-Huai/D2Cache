...
def eval_teacache_slow(prompt_list, loop=5, base_seed=1):
    LTXVideoTransformer3DModel.forward = teacache_forward
    ...
    pipe.transformer.__class__.cnt = 0
    pipe.transformer.__class__.num_steps = num_inference_steps
    pipe.transformer.__class__.rel_l1_thresh = 0.05 # 
    pipe.transformer.__class__.accumulated_rel_l1_distance = 0
    pipe.transformer.__class__.previous_modulated_input = None
    pipe.transformer.__class__.previous_residual = None

    output_dir = "./ltx_teacache_slow"
    os.makedirs(output_dir, exist_ok=True)
...
def eval_teacache_fast(prompt_list, loop=5, base_seed=1):
    LTXVideoTransformer3DModel.forward = teacache_forward
    ...
    pipe.transformer.__class__.cnt = 0
    pipe.transformer.__class__.num_steps = num_inference_steps
    pipe.transformer.__class__.rel_l1_thresh = 0.10 # 2 speedup 
    pipe.transformer.__class__.accumulated_rel_l1_distance = 0
    pipe.transformer.__class__.previous_modulated_input = None
    pipe.transformer.__class__.previous_residual = None
    output_dir = "./ltx_teacache_fast"
    os.makedirs(output_dir, exist_ok=True)
    gen_cnt = 0
    pipe.to("cuda")
    for i in range(loop):
...
def eval_teacache_superfast(prompt_list, loop=5, base_seed=1):
    LTXVideoTransformer3DModel.forward = teacache_forward
    ...
    pipe.transformer.__class__.previous_modulated_input = None
    pipe.transformer.__class__.previous_residual = None
    output_dir = "./ltx_teacache_superfast"
    os.makedirs(output_dir, exist_ok=True)
    gen_cnt = 0
    pipe.to("cuda")
    for i in range(loop):
...
if __name__ == "__main__":
    ...
    # eval_teacache_slow(prompt_list, loop=5, base_seed=1)
    eval_teacache_fast(prompt_list, loop=5, base_seed=1)
    # eval_teacache_superfast(prompt_list, loop=5, base_seed=1)
